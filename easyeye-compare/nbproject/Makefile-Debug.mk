...
LDLIBSOPTIONS=../easyeye/dist/Debug/GNU-Linux-x86/libeasyeye.a ../optimasek/dist/Debug/GNU-Linux-x86/liboptimasek.a -ljsoncpp

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/easyeye-compare

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/easyeye-compare: ../easyeye/dist/Debug/GNU-Linux-x86/libeasyeye.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/easyeye-compare: ../optimasek/dist/Debug/GNU-Linux-x86/liboptimasek.a
...
${OBJECTDIR}/src/easyeye_compare_main.o: src/easyeye_compare_main.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../easyeye/src -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye_compare_main.o src/easyeye_compare_main.cc
...
${OBJECTDIR}/src/easyeye_compare_main_nomain.o: ${OBJECTDIR}/src/easyeye_compare_main.o src/easyeye_compare_main.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../easyeye/src -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye_compare_main_nomain.o src/easyeye_compare_main.cc;\
	else  \
