...
${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_detection.o: src/easyeye/segment/easyeye_eyelid_detection.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/segment
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_detection.o src/easyeye/segment/easyeye_eyelid_detection.cc
...
${TESTDIR}/tests/HoughParabolaTransform.o: tests/HoughParabolaTransform.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/HoughParabolaTransform.o tests/HoughParabolaTransform.cc
...
${TESTDIR}/tests/RotatedShapeTest.o: tests/RotatedShapeTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RotatedShapeTest.o tests/RotatedShapeTest.cc


${TESTDIR}/tests/rotated_shape_test_runner.o: tests/rotated_shape_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/rotated_shape_test_runner.o tests/rotated_shape_test_runner.cc
...
${TESTDIR}/tests/TypesTest.o: tests/TypesTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TypesTest.o tests/TypesTest.cc


${TESTDIR}/tests/types_test_runner.o: tests/types_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/types_test_runner.o tests/types_test_runner.cc
...
${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_detection_nomain.o: ${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_detection.o src/easyeye/segment/easyeye_eyelid_detection.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_detection_nomain.o src/easyeye/segment/easyeye_eyelid_detection.cc;\
	else  \
