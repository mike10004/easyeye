...
${OBJECTDIR}/src/easyeye/common/base64.o: src/easyeye/common/base64.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/base64.o src/easyeye/common/base64.cc

${OBJECTDIR}/src/easyeye/common/easyeye_config.o: src/easyeye/common/easyeye_config.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_config.o src/easyeye/common/easyeye_config.cc

${OBJECTDIR}/src/easyeye/common/easyeye_diagnostics.o: src/easyeye/common/easyeye_diagnostics.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_diagnostics.o src/easyeye/common/easyeye_diagnostics.cc

${OBJECTDIR}/src/easyeye/common/easyeye_imaging.o: src/easyeye/common/easyeye_imaging.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_imaging.o src/easyeye/common/easyeye_imaging.cc

${OBJECTDIR}/src/easyeye/common/easyeye_program.o: src/easyeye/common/easyeye_program.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_program.o src/easyeye/common/easyeye_program.cc

${OBJECTDIR}/src/easyeye/common/easyeye_serial.o: src/easyeye/common/easyeye_serial.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_serial.o src/easyeye/common/easyeye_serial.cc

${OBJECTDIR}/src/easyeye/common/easyeye_types.o: src/easyeye/common/easyeye_types.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_types.o src/easyeye/common/easyeye_types.cc

${OBJECTDIR}/src/easyeye/common/easyeye_utils.o: src/easyeye/common/easyeye_utils.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_utils.o src/easyeye/common/easyeye_utils.cc

${OBJECTDIR}/src/easyeye/common/mylog.o: src/easyeye/common/mylog.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/mylog.o src/easyeye/common/mylog.cc

${OBJECTDIR}/src/easyeye/encode/easyeye_encode.o: src/easyeye/encode/easyeye_encode.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/encode
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/encode/easyeye_encode.o src/easyeye/encode/easyeye_encode.cc

${OBJECTDIR}/src/easyeye/encode/easyeye_encoding.o: src/easyeye/encode/easyeye_encoding.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/encode
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/encode/easyeye_encoding.o src/easyeye/encode/easyeye_encoding.cc

${OBJECTDIR}/src/easyeye/encode/easyeye_encoding_serial.o: src/easyeye/encode/easyeye_encoding_serial.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/encode
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/encode/easyeye_encoding_serial.o src/easyeye/encode/easyeye_encoding_serial.cc

${OBJECTDIR}/src/easyeye/encode/easyeye_normalize.o: src/easyeye/encode/easyeye_normalize.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/encode
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/encode/easyeye_normalize.o src/easyeye/encode/easyeye_normalize.cc

${OBJECTDIR}/src/easyeye/match/HDCalculator.o: src/easyeye/match/HDCalculator.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/match
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/match/HDCalculator.o src/easyeye/match/HDCalculator.cc

${OBJECTDIR}/src/easyeye/match/easyeye_match.o: src/easyeye/match/easyeye_match.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/match
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/match/easyeye_match.o src/easyeye/match/easyeye_match.cc

${OBJECTDIR}/src/easyeye/segment/FindEyelidMix.o: src/easyeye/segment/FindEyelidMix.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/segment
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/FindEyelidMix.o src/easyeye/segment/FindEyelidMix.cpp

${OBJECTDIR}/src/easyeye/segment/FindIrisCircle.o: src/easyeye/segment/FindIrisCircle.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/segment
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/FindIrisCircle.o src/easyeye/segment/FindIrisCircle.cpp

${OBJECTDIR}/src/easyeye/segment/FindPupilCircleNew.o: src/easyeye/segment/FindPupilCircleNew.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/segment
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/FindPupilCircleNew.o src/easyeye/segment/FindPupilCircleNew.cpp

${OBJECTDIR}/src/easyeye/segment/easyeye_extrema_noise.o: src/easyeye/segment/easyeye_extrema_noise.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/segment
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/easyeye_extrema_noise.o src/easyeye/segment/easyeye_extrema_noise.cpp

${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_detection.o: src/easyeye/segment/easyeye_eyelid_detection.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/segment
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_detection.o src/easyeye/segment/easyeye_eyelid_detection.cc

${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_finder.o: src/easyeye/segment/easyeye_eyelid_finder.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/segment
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_finder.o src/easyeye/segment/easyeye_eyelid_finder.cc

${OBJECTDIR}/src/easyeye/segment/easyeye_segment.o: src/easyeye/segment/easyeye_segment.cc 
	${MKDIR} -p ${OBJECTDIR}/src/easyeye/segment
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/easyeye_segment.o src/easyeye/segment/easyeye_segment.cc
...
${TESTDIR}/TestFiles/f19: ${TESTDIR}/tests/DualParabolaEyelidFinderTest.o ${TESTDIR}/tests/dual_parabola_eyelid_finder_test_runner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f19 $^ ${LDLIBSOPTIONS} ../optimasek/dist/Release/GNU-Linux-x86/liboptimasek.a -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_objdetect -ljsoncpp -luuid `cppunit-config --libs`   
...
${TESTDIR}/TestFiles/f18: ${TESTDIR}/tests/eyelid_parabola_ranges_analysis.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f18 $^ ${LDLIBSOPTIONS} ../optimasek/dist/Release/GNU-Linux-x86/liboptimasek.a -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_objdetect -ljsoncpp -luuid 

${TESTDIR}/TestFiles/f17: ${TESTDIR}/tests/RotatedShapeTest.o ${TESTDIR}/tests/rotated_shape_test_runner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f17 $^ ${LDLIBSOPTIONS} ../optimasek/dist/Release/GNU-Linux-x86/liboptimasek.a -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_objdetect -ljsoncpp -luuid `cppunit-config --libs`   
...
${TESTDIR}/TestFiles/f14: ${TESTDIR}/tests/TypesTest.o ${TESTDIR}/tests/types_test_runner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f14 $^ ${LDLIBSOPTIONS} ../optimasek/dist/Release/GNU-Linux-x86/liboptimasek.a -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_objdetect -ljsoncpp -luuid `cppunit-config --libs`   
...
${TESTDIR}/tests/base64_test.o: tests/base64_test.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/base64_test.o tests/base64_test.cc


${TESTDIR}/tests/BitPackingTest.o: tests/BitPackingTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BitPackingTest.o tests/BitPackingTest.cc


${TESTDIR}/tests/bitpacking_test_runner.o: tests/bitpacking_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/bitpacking_test_runner.o tests/bitpacking_test_runner.cc


${TESTDIR}/tests/CommonSerialTest.o: tests/CommonSerialTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CommonSerialTest.o tests/CommonSerialTest.cc


${TESTDIR}/tests/common_serial_test_runner.o: tests/common_serial_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/common_serial_test_runner.o tests/common_serial_test_runner.cc


${TESTDIR}/tests/DiagnosticsTest.o: tests/DiagnosticsTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/DiagnosticsTest.o tests/DiagnosticsTest.cpp


${TESTDIR}/tests/diagnostics_test_runner.o: tests/diagnostics_test_runner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/diagnostics_test_runner.o tests/diagnostics_test_runner.cpp


${TESTDIR}/tests/DualParabolaEyelidFinderTest.o: tests/DualParabolaEyelidFinderTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/DualParabolaEyelidFinderTest.o tests/DualParabolaEyelidFinderTest.cc


${TESTDIR}/tests/dual_parabola_eyelid_finder_test_runner.o: tests/dual_parabola_eyelid_finder_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/dual_parabola_eyelid_finder_test_runner.o tests/dual_parabola_eyelid_finder_test_runner.cc


${TESTDIR}/tests/EncodingTest.o: tests/EncodingTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/EncodingTest.o tests/EncodingTest.cc


${TESTDIR}/tests/encoding_test_runner.o: tests/encoding_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/encoding_test_runner.o tests/encoding_test_runner.cc


${TESTDIR}/tests/EyelidFixTest.o: tests/EyelidFixTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/EyelidFixTest.o tests/EyelidFixTest.cc


${TESTDIR}/tests/eyelid_fix_test_runner.o: tests/eyelid_fix_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/eyelid_fix_test_runner.o tests/eyelid_fix_test_runner.cc


${TESTDIR}/tests/FilesTest.o: tests/FilesTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/FilesTest.o tests/FilesTest.cc


${TESTDIR}/tests/files_test_runner.o: tests/files_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/files_test_runner.o tests/files_test_runner.cc


${TESTDIR}/tests/FindEyelidsTest.o: tests/FindEyelidsTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/FindEyelidsTest.o tests/FindEyelidsTest.cc


${TESTDIR}/tests/find_eyelids_test_runner.o: tests/find_eyelids_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/find_eyelids_test_runner.o tests/find_eyelids_test_runner.cc


${TESTDIR}/tests/HoughParabolaTest.o: tests/HoughParabolaTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/HoughParabolaTest.o tests/HoughParabolaTest.cc


${TESTDIR}/tests/HoughParabolaTransform.o: tests/HoughParabolaTransform.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/HoughParabolaTransform.o tests/HoughParabolaTransform.cc


${TESTDIR}/tests/hough_parabola_test_runner.o: tests/hough_parabola_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/hough_parabola_test_runner.o tests/hough_parabola_test_runner.cc


${TESTDIR}/tests/ImagingTest.o: tests/ImagingTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ImagingTest.o tests/ImagingTest.cc


${TESTDIR}/tests/imaging_test_runner.o: tests/imaging_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/imaging_test_runner.o tests/imaging_test_runner.cc


${TESTDIR}/tests/MatchingTest.o: tests/MatchingTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -I. -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MatchingTest.o tests/MatchingTest.cc


${TESTDIR}/tests/matching_test_runner.o: tests/matching_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -I. -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/matching_test_runner.o tests/matching_test_runner.cc


${TESTDIR}/tests/eyelid_parabola_ranges_analysis.o: tests/eyelid_parabola_ranges_analysis.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/eyelid_parabola_ranges_analysis.o tests/eyelid_parabola_ranges_analysis.cc


${TESTDIR}/tests/RotatedShapeTest.o: tests/RotatedShapeTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RotatedShapeTest.o tests/RotatedShapeTest.cc


${TESTDIR}/tests/rotated_shape_test_runner.o: tests/rotated_shape_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/rotated_shape_test_runner.o tests/rotated_shape_test_runner.cc


${TESTDIR}/tests/SegmentationSerializerTest.o: tests/SegmentationSerializerTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/SegmentationSerializerTest.o tests/SegmentationSerializerTest.cc


${TESTDIR}/tests/segment_serial_test_runner.o: tests/segment_serial_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/segment_serial_test_runner.o tests/segment_serial_test_runner.cc


${TESTDIR}/tests/segmentation_correctness_test.o: tests/segmentation_correctness_test.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/segmentation_correctness_test.o tests/segmentation_correctness_test.cc


${TESTDIR}/tests/TypesTest.o: tests/TypesTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TypesTest.o tests/TypesTest.cc


${TESTDIR}/tests/types_test_runner.o: tests/types_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/types_test_runner.o tests/types_test_runner.cc


${TESTDIR}/tests/utils_test.o: tests/utils_test.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/utils_test.o tests/utils_test.cc


${TESTDIR}/tests/VasirComparisonTest.o: tests/VasirComparisonTest.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/VasirComparisonTest.o tests/VasirComparisonTest.cc


${TESTDIR}/tests/vasir_comparison_test_runner.o: tests/vasir_comparison_test_runner.cc 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../optimasek/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/vasir_comparison_test_runner.o tests/vasir_comparison_test_runner.cc
...
${OBJECTDIR}/src/easyeye/common/base64_nomain.o: ${OBJECTDIR}/src/easyeye/common/base64.o src/easyeye/common/base64.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/base64_nomain.o src/easyeye/common/base64.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/common/easyeye_config_nomain.o: ${OBJECTDIR}/src/easyeye/common/easyeye_config.o src/easyeye/common/easyeye_config.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_config_nomain.o src/easyeye/common/easyeye_config.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/common/easyeye_diagnostics_nomain.o: ${OBJECTDIR}/src/easyeye/common/easyeye_diagnostics.o src/easyeye/common/easyeye_diagnostics.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_diagnostics_nomain.o src/easyeye/common/easyeye_diagnostics.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/common/easyeye_imaging_nomain.o: ${OBJECTDIR}/src/easyeye/common/easyeye_imaging.o src/easyeye/common/easyeye_imaging.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_imaging_nomain.o src/easyeye/common/easyeye_imaging.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/common/easyeye_program_nomain.o: ${OBJECTDIR}/src/easyeye/common/easyeye_program.o src/easyeye/common/easyeye_program.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_program_nomain.o src/easyeye/common/easyeye_program.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/common/easyeye_serial_nomain.o: ${OBJECTDIR}/src/easyeye/common/easyeye_serial.o src/easyeye/common/easyeye_serial.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_serial_nomain.o src/easyeye/common/easyeye_serial.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/common/easyeye_types_nomain.o: ${OBJECTDIR}/src/easyeye/common/easyeye_types.o src/easyeye/common/easyeye_types.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_types_nomain.o src/easyeye/common/easyeye_types.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/common/easyeye_utils_nomain.o: ${OBJECTDIR}/src/easyeye/common/easyeye_utils.o src/easyeye/common/easyeye_utils.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/easyeye_utils_nomain.o src/easyeye/common/easyeye_utils.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/common/mylog_nomain.o: ${OBJECTDIR}/src/easyeye/common/mylog.o src/easyeye/common/mylog.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/common/mylog_nomain.o src/easyeye/common/mylog.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/encode/easyeye_encode_nomain.o: ${OBJECTDIR}/src/easyeye/encode/easyeye_encode.o src/easyeye/encode/easyeye_encode.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/encode/easyeye_encode_nomain.o src/easyeye/encode/easyeye_encode.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/encode/easyeye_encoding_nomain.o: ${OBJECTDIR}/src/easyeye/encode/easyeye_encoding.o src/easyeye/encode/easyeye_encoding.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/encode/easyeye_encoding_nomain.o src/easyeye/encode/easyeye_encoding.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/encode/easyeye_encoding_serial_nomain.o: ${OBJECTDIR}/src/easyeye/encode/easyeye_encoding_serial.o src/easyeye/encode/easyeye_encoding_serial.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/encode/easyeye_encoding_serial_nomain.o src/easyeye/encode/easyeye_encoding_serial.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/encode/easyeye_normalize_nomain.o: ${OBJECTDIR}/src/easyeye/encode/easyeye_normalize.o src/easyeye/encode/easyeye_normalize.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/encode/easyeye_normalize_nomain.o src/easyeye/encode/easyeye_normalize.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/match/HDCalculator_nomain.o: ${OBJECTDIR}/src/easyeye/match/HDCalculator.o src/easyeye/match/HDCalculator.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/match/HDCalculator_nomain.o src/easyeye/match/HDCalculator.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/match/easyeye_match_nomain.o: ${OBJECTDIR}/src/easyeye/match/easyeye_match.o src/easyeye/match/easyeye_match.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/match/easyeye_match_nomain.o src/easyeye/match/easyeye_match.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/segment/FindEyelidMix_nomain.o: ${OBJECTDIR}/src/easyeye/segment/FindEyelidMix.o src/easyeye/segment/FindEyelidMix.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/FindEyelidMix_nomain.o src/easyeye/segment/FindEyelidMix.cpp;\
	else  \
...
${OBJECTDIR}/src/easyeye/segment/FindIrisCircle_nomain.o: ${OBJECTDIR}/src/easyeye/segment/FindIrisCircle.o src/easyeye/segment/FindIrisCircle.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/FindIrisCircle_nomain.o src/easyeye/segment/FindIrisCircle.cpp;\
	else  \
...
${OBJECTDIR}/src/easyeye/segment/FindPupilCircleNew_nomain.o: ${OBJECTDIR}/src/easyeye/segment/FindPupilCircleNew.o src/easyeye/segment/FindPupilCircleNew.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/FindPupilCircleNew_nomain.o src/easyeye/segment/FindPupilCircleNew.cpp;\
	else  \
...
${OBJECTDIR}/src/easyeye/segment/easyeye_extrema_noise_nomain.o: ${OBJECTDIR}/src/easyeye/segment/easyeye_extrema_noise.o src/easyeye/segment/easyeye_extrema_noise.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/easyeye_extrema_noise_nomain.o src/easyeye/segment/easyeye_extrema_noise.cpp;\
	else  \
...
${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_detection_nomain.o: ${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_detection.o src/easyeye/segment/easyeye_eyelid_detection.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_detection_nomain.o src/easyeye/segment/easyeye_eyelid_detection.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_finder_nomain.o: ${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_finder.o src/easyeye/segment/easyeye_eyelid_finder.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/easyeye_eyelid_finder_nomain.o src/easyeye/segment/easyeye_eyelid_finder.cc;\
	else  \
...
${OBJECTDIR}/src/easyeye/segment/easyeye_segment_nomain.o: ${OBJECTDIR}/src/easyeye/segment/easyeye_segment.o src/easyeye/segment/easyeye_segment.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../optimasek/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/easyeye/segment/easyeye_segment_nomain.o src/easyeye/segment/easyeye_segment.cc;\
	else  \
