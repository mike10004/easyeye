...
${OBJECTDIR}/src/adjgamma.o: src/adjgamma.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/adjgamma.o src/adjgamma.cpp

${OBJECTDIR}/src/canny.o: src/canny.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/canny.o src/canny.cpp

${OBJECTDIR}/src/circlecoordinates.o: src/circlecoordinates.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/circlecoordinates.o src/circlecoordinates.cpp

${OBJECTDIR}/src/common.o: src/common.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/common.o src/common.cpp

${OBJECTDIR}/src/encode.o: src/encode.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/encode.o src/encode.cpp

${OBJECTDIR}/src/findcircle.o: src/findcircle.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/findcircle.o src/findcircle.cpp

${OBJECTDIR}/src/findline.o: src/findline.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/findline.o src/findline.cpp

${OBJECTDIR}/src/gaborconvolve.o: src/gaborconvolve.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gaborconvolve.o src/gaborconvolve.cpp

${OBJECTDIR}/src/gauss.o: src/gauss.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gauss.o src/gauss.cpp

${OBJECTDIR}/src/houcircle.o: src/houcircle.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/houcircle.o src/houcircle.cpp

${OBJECTDIR}/src/hysthresh.o: src/hysthresh.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hysthresh.o src/hysthresh.cpp

${OBJECTDIR}/src/interp2.o: src/interp2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/interp2.o src/interp2.cpp

${OBJECTDIR}/src/linecoords.o: src/linecoords.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/linecoords.o src/linecoords.cpp

${OBJECTDIR}/src/nonmaxsup.o: src/nonmaxsup.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nonmaxsup.o src/nonmaxsup.cpp

${OBJECTDIR}/src/normalizeiris.o: src/normalizeiris.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/normalizeiris.o src/normalizeiris.cpp

${OBJECTDIR}/src/portability.o: src/portability.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/portability.o src/portability.cc

${OBJECTDIR}/src/radon.o: src/radon.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/radon.o src/radon.cpp

${OBJECTDIR}/src/segmentiris.o: src/segmentiris.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/segmentiris.o src/segmentiris.cpp

${OBJECTDIR}/src/shiftbits.o: src/shiftbits.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shiftbits.o src/shiftbits.cpp
